...
const Success = () => {
  ...
  return (
    <div className='max-w-4xl mx-auto my-40 p-5 bg-green-100 rounded-lg shadow'>
      <h1 className='text-3xl font-bold text-green-800'>Ödeme başarılı!</h1>
      {orderDetails ? (
        <div>
        ...
        <p className='mt-4'>Sipariş detayları yükleniyor..</p>
      )}
      <div className='mt-4'>
        <Link to="/" className='bg-green-600 hover:bg-green-900 text-white py-2 px-4 font-semibold'>Anasayfaya geri dönün</Link>
      </div>
